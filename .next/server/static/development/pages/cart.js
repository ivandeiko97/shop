...
function Cart({
  ...
  if (cart.length !== 0) {
    return __jsx("div", {
      ...
      __self: this
    }, cart.map(product => __jsx(_product_Product__WEBPACK_IMPORTED_MODULE_1__["default"], {
      key: product.id,
      cartProd: true,
      product: product,
      __source: {
...
/* harmony import */ var _components_cart_Cart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/cart/Cart */ "./components/cart/Cart.jsx");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(null, null)(Cart));
...
module.exports = __webpack_require__(/*! O:\MyProject\myShop\with-redux-app\pages\cart.js */"./pages/cart.js");

...
/* harmony default export */ __webpack_exports__["default"] = ((state = initialState, action) => {
  switch (action.type) {
    case _action__WEBPACK_IMPORTED_MODULE_1__["BUY_PRODUCT"]:
      const {
        products,
        cart
      } = state;
    ...
    case _action__WEBPACK_IMPORTED_MODULE_1__["DELETE_FROM_CART"]:
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, {
        cart: state.cart.filter(product => product.id !== action.id)
      });

    case _action__WEBPACK_IMPORTED_MODULE_1__["PLUS_COUNT_PRODUCT"]:
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, {
    ...
    case _action__WEBPACK_IMPORTED_MODULE_1__["MINUS_COUNT_PRODUCT"]:
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, {
        cart: state.cart.map(product => {
          if (product.id === action.id) {
            return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, product, {
...
function initializeStore() {
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_redux_reducer__WEBPACK_IMPORTED_MODULE_1__["default"]);
}
